...
specific to the ts-type-refiner domain:
    ...
    4. Defining the eval semantics (autoregressive exact-match accuracy)
     5. Wiring the above into `ts_type_refiner.training.trainer.train(...)` and
...
from ts_type_refiner.training.trainer import EpochStats, TrainConfig, train
...
def main() -> None:
    ...
    def on_epoch_end(stats: EpochStats) -> bool | None:
        ...
        #
        # In other words:
        #   ts_type_refiner.training.trainer.train(...) = mechanics of optimization
